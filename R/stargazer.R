...
function(..., type = "text", title="", style="default", summary=NULL, out=NULL, out.header=FALSE,
         column.labels=NULL, column.separate = NULL, covariate.labels=NULL, dep.var.caption="", 
         dep.var.labels=NULL, dep.var.labels.include=FALSE, align=FALSE, coef=NULL, se=NULL, t=NULL, 
         ...
         intercept.top=FALSE, keep=NULL, keep.stat = 'n', label="", model.names=FALSE, model.numbers=NULL, 
         multicolumn=TRUE, no.space=TRUE, notes=NULL, notes.align=NULL, notes.append=TRUE, notes.label=NULL, 
         object.names=FALSE,
